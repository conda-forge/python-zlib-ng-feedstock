...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/python-zlib-ng-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-zlib-ng-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=18642&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-zlib-ng-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_python3.15.____cp315" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add python-zlib-ng
# for installing globally
pixi global install python-zlib-ng
```
...
It is possible to list all of the versions of `python-zlib-ng` available on your platform:
...
```
pixi search python-zlib-ng --channel conda-forge
```
